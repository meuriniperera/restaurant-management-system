...
try {
    ...
    $select_products = $conn->prepare("SELECT * FROM menu_items WHERE name LIKE ? AND (category_id = ? OR ? = '%')");
    $select_products->execute([$search, $category, $category]);
...
<head>
    ...
    <title>Gallery Cafe - Search Results</title>
    <style type="text/css">
    ...
    <div class="main">
        <section class="products">
            <form action="search.php" method="get" class="search-form">
                <input type="text" name="search" placeholder="Search for products..." class="search-box">
